...
const GROUPS = [
    ...
    },
    {
        ...
        text: "Neoline — радар-детекторы бар гибридтер және 26 490 ₸-ден бастап 4K флагмандарға дейінгі тіркеуіштер, сондай-ақ Artway мен Kristall-Auto. Автосалондарға, сервистерге және автотауар дүкендеріне көтермелеп сатамыз.",
        links: [
            { href: "/kk/videoregistratory-neoline/", label: "Neoline каталогы" },
    ...
    return (
        <section className="py-2">
            ...
            <p className="max-w-[76ch] text-neutral-600 dark:text-neutral-300 mb-6">
                StarLine күзет кешендерінен бөлек «Пегас Авто А» бейнетіркегіштер мен Android
                магнитолаларын жеткізеді әрі орнатады. Бәрі Атыраудағы өз қоймамыздан — автосалондарға,
                сервистерге және дүкендерге көтермелеп, жеке иелерге бөлшектеп.
            </p>
