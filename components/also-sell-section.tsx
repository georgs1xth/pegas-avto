...
const GROUPS = [
    ...
    },
    {
        ...
        text: "Мы официальный дистрибьютор Neoline в Атырау: гибриды с радар-детектором и регистраторы от 26 490 ₸ до 4K-флагманов, а также Artway и Kristall-Auto. Опт автосалонам, сервисам и магазинам автотоваров.",
        links: [
