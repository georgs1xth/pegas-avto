...
const FilterPrice = ({
  ...
  return (
    <div className="flex gap-2 justify-end relative min-h-9">
        {/* <DropdownMenu>
            <DropdownMenuTrigger className="group inline-flex justify-center text-sm font-normal hover:text-accent-foreground/80 transition-colors duration-100 gap-1 border-accent-foreground/10 border p-2 rounded-lg">
                Сортировка
