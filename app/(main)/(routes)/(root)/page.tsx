...
export const metadata: Metadata = {
    ...
    description: "«Пегас Авто А» — официальный дилер и дистрибьютор StarLine в Атырау: сигнализации, видеорегистраторы Neoline, Android-магнитолы. Опт и розница, две точки.",
};
